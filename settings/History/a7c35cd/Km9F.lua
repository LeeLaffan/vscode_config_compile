...
function barracks_spawn_soldier:OnSpellStart()
    ...
    ListenToGameEvent('prizepool_received', barracks_spawn_soldier:OnEntityKilled, nil)

end

function barracks_spawn_soldier:OnEntityKilled(arg)
    if not IsServer() then return end
--     print("Killed")
--     local killedUnit = EntIndexToHScript( keys.entindex_killed )
    print("ded ", table.concat(arg))
--     print(killedUnit)
end
