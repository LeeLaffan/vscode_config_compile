...
ListenToGameEvent('npc_spawned', Dynamic_Wrap(barracks_spawn_soldier, "OnEntitySpawn"), nil)
...
function barracks_spawn_soldier:OnEntitySpawn(args)
    print("Bar Entity SPAWNED")
end
