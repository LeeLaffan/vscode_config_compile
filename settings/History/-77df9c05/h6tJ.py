...
def main():
    ...
    parser.add_argument("-c", "--compiled", type=str, help="Mode to run the script")
    parser.add_argument("-v", "--vscode", type=str, help="Mode to run the script")
    args=parser.parse_args()

    full_lines = read_json_files(args.compiled)
