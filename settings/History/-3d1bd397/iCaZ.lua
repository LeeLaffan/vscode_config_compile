...
function RaxManager.OnRaxCreated(soldier_name, rax_id)
    ...
    raxEnt:AddNewModifier(raxEnt, nil, "soldier_respawn_modifier", kv)
end
...
function RaxManager.SpawnUnit(rax_id)
    ...
    print("rally is "..soldier)

    local john = CreateUnitByName(soldier, rally, true, nil, nil, DOTA_TEAM_GOODGUYS)
